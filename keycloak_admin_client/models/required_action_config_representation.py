...
class RequiredActionConfigRepresentation(ModelNormal):
    ...
    def __init__(self, _check_type=True, _from_server=False, _path_to_item=(), _configuration=None, _visited_composed_classes=(), **kwargs):  # noqa: E501
        """required_action_config_representation.RequiredActionConfigRepresentation - a model defined in OpenAPI
