...
class PolicyEvaluationRequest(ModelNormal):
    ...
    def __init__(self, _check_type=True, _from_server=False, _path_to_item=(), _configuration=None, _visited_composed_classes=(), **kwargs):  # noqa: E501
        """policy_evaluation_request.PolicyEvaluationRequest - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            context ({str: ({str: (str,)},)}): [optional]  # noqa: E501
