...
class TenantVendorsReqSchema(ModelNormal):
    ...
    @convert_js_args_to_python_args
    def __init__(self, contact_fullname, contact_mobile, contact_email, _check_type=True, _from_server=False, _path_to_item=(), _configuration=None, _visited_composed_classes=(), **kwargs):  # noqa: E501
        """tenant_vendors_req_schema.TenantVendorsReqSchema - a model defined in OpenAPI
