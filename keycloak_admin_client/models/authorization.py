...
try:
    from keycloak_admin_client.models import permission
except ImportError:
    permission = sys.modules[
        'openapi_client.models.permission']
...
class Authorization(ModelNormal):
    ...
    def openapi_types():
        ...
        """
        return {
            'permissions': ([permission.Permission],),  # noqa: E501
        }
    ...
    def __init__(self, _check_type=True, _from_server=False, _path_to_item=(), _configuration=None, _visited_composed_classes=(), **kwargs):  # noqa: E501
        """authorization.Authorization - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            permissions ([permission.Permission]): [optional]  # noqa: E501
        """
