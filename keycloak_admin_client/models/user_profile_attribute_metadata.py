...
class UserProfileAttributeMetadata(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'validators': ({str: ({str: (str,)},)},),  # noqa: E501
            'group': (str,),  # noqa: E501
    ...
    def __init__(self, _check_type=True, _from_server=False, _path_to_item=(), _configuration=None, _visited_composed_classes=(), **kwargs):  # noqa: E501
        """user_profile_attribute_metadata.UserProfileAttributeMetadata - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            validators ({str: ({str: (str,)},)}): [optional]  # noqa: E501
