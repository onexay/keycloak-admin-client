...
class VendorReqSchema(ModelNormal):
    ...
    @convert_js_args_to_python_args
    def __init__(self, name, address, tax_id, contact_fullname, contact_mobile, contact_email, _check_type=True, _from_server=False, _path_to_item=(), _configuration=None, _visited_composed_classes=(), **kwargs):  # noqa: E501
        """vendor_req_schema.VendorReqSchema - a model defined in OpenAPI
