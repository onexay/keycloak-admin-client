...
class TenantResSchema(ModelNormal):
    ...
    @convert_js_args_to_python_args
    def __init__(self, name, address, tax_id, id, created_ts, updated_ts, _check_type=True, _from_server=False, _path_to_item=(), _configuration=None, _visited_composed_classes=(), **kwargs):  # noqa: E501
        """tenant_res_schema.TenantResSchema - a model defined in OpenAPI
