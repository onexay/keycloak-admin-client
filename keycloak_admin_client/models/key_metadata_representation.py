...
try:
    from keycloak_admin_client.models import key_use
except ImportError:
    key_use = sys.modules[
        'openapi_client.models.key_use']


class KeyMetadataRepresentation(ModelNormal):
    ...
    def __init__(self, _check_type=True, _from_server=False, _path_to_item=(), _configuration=None, _visited_composed_classes=(), **kwargs):  # noqa: E501
        """key_metadata_representation.KeyMetadataRepresentation - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            use (key_use.KeyUse): [optional]  # noqa: E501
            valid_to (int): [optional]  # noqa: E501
        """
