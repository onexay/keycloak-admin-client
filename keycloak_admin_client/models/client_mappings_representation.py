...
class ClientMappingsRepresentation(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'mappings': ([role_representation.RoleRepresentation],),  # noqa: E501
        }
    ...
    def __init__(self, _check_type=True, _from_server=False, _path_to_item=(), _configuration=None, _visited_composed_classes=(), **kwargs):  # noqa: E501
        """client_mappings_representation.ClientMappingsRepresentation - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            mappings ([role_representation.RoleRepresentation]): [optional]  # noqa: E501
        """
