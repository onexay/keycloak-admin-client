...
class Pet(ModelNormal):
    ...
    @convert_js_args_to_python_args
    def __init__(self, id, category, name, photo_urls, tags, status, _check_type=True, _from_server=False, _path_to_item=(), _configuration=None, _visited_composed_classes=(), **kwargs):  # noqa: E501
