...
class Composites(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            'realm': ([str],),  # noqa: E501
            'client': ({str: ([str],)},),  # noqa: E501
            'application': ({str: ([str],)},),  # noqa: E501
        }
    ...
    def __init__(self, _check_type=True, _from_server=False, _path_to_item=(), _configuration=None, _visited_composed_classes=(), **kwargs):  # noqa: E501
        """composites.Composites - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            client ({str: ([str],)}): [optional]  # noqa: E501
            application ({str: ([str],)}): [optional]  # noqa: E501
        """
